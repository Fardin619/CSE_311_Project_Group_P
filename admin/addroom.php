...
{
    extract($_REQUEST);
    $result=$user->add_room($roomname, $room_qnty, $available, $booked,,$price);
    if($result)
    {
        ...
        <div class="well">
            ...
            <form action="" method="post" name="room_category">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="roomname" placeholder="easy" required>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" name="booked"></textarea>
                </div>
               <div class="form-group">
