        ...
        <div class="well">
            ...
            <form action="" method="post" name="reg">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fullname" placeholder="example: Jhon Wick" required>
                </div>
                <div class="form-group">
                    <label for="uname">User Name:</label>
                    <input type="text" class="form-control" name="uname" placeholder="exmple: babayega" required>
                </div>
                <div class="form-group">
